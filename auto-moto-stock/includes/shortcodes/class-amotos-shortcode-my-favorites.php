...
if (!class_exists('AMOTOS_Shortcode_My_Favorites')) {
	/**
	 * Class AMOTOS_Shortcode_My_Favorites
	 */
	class AMOTOS_Shortcode_My_Favorites
	{
		public static function output($atts)
		{
			...
			amotos_get_template('car/my-favorites.php', array('favorites' => $favorites, 'max_num_pages' => $favorites->max_num_pages));
			return ob_get_clean();
		}
	}
}