(function ($) {
	$(document).ready(function() {
		...
		function init_upload() {
			$(".amotos-image-upload").on('click', function (event) {
				...
				custom_file_frame.on("select", function () {
					...
					$('.amotos-image-screenshot', activeFileUploadContext).attr('src', attachment.attributes.url);
					...
					$('.amotos-image-upload', activeFileUploadContext).hide();
					$('.amotos-image-screenshot', activeFileUploadContext).show();
					$('.amotos-image-upload-remove', activeFileUploadContext).show();
				});
				custom_file_frame.open();
			});
			$(".amotos-image-upload-remove").on('click', function (event) {
				var activeFileUploadContext = $(this).parent();
				...
				$('.amotos-image-screenshot', activeFileUploadContext).fadeOut('slow');
