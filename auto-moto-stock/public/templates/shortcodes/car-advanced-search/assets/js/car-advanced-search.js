var AMOTOS_Car_Advanced_Search = AMOTOS_Car_Advanced_Search || {};
(function ($) {
    'use strict';
    var ajax_url = '';// amotos_car_advanced_search_vars.ajax_url;
    var price_is_slider = '';// amotos_car_advanced_search_vars.price_is_slider;
    var css_class_wrap = '.amotos-car-advanced-search';

    AMOTOS_Car_Advanced_Search = {
        init: function () {
            ...
            if (typeof ($(css_class_wrap).data('options')) !== "undefined") {
                window['amotos_car_advanced_search_vars'] = $(css_class_wrap).data('options');
            }

            if (typeof (amotos_car_advanced_search_vars) === "undefined") {
                return;
            }

            ajax_url = amotos_car_advanced_search_vars.ajax_url;
            price_is_slider = amotos_car_advanced_search_vars.price_is_slider;


            var enable_filter_location=amotos_car_advanced_search_vars.enable_filter_location;
            ...
            $('.btn-status-filter', css_class_wrap).on('click', function (e) {
                ...
                AMOTOS_Car_Advanced_Search.change_price_on_status_change(status);
            });
            ...
            $(".amotos-sliderbar-filter.amotos-sliderbar-price", css_class_wrap).on('register.again', function () {
                $(".amotos-sliderbar-filter.amotos-sliderbar-price", css_class_wrap).each(function () {
                    ...
                    AMOTOS_Car_Advanced_Search.set_slider_filter(slider_filter);
                });
            });
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.slide_html) {
                        ...
                        AMOTOS_Car_Advanced_Search.register_slider_filter();
                        AMOTOS_Car_Advanced_Search.set_slider_value();
                    }
                    else {
    ...
    $(document).ready(function () {
        if (!$('body').hasClass('elementor-editor-active')) {
            AMOTOS_Car_Advanced_Search.init();
        }
    });
})(jQuery);