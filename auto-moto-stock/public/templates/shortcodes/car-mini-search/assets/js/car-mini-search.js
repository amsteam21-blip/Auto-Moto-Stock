jQuery(document).ready(function ($) {
    ...
    function amotos_execute_url_mini_search() {
        $('#mini-search-btn', '.amotos-mini-search-cars-form').on('click', function (e) {
            e.preventDefault();
            var search_form = $(this).closest('.amotos-mini-search-cars-form'),
    ...
    amotos_execute_url_mini_search();
});