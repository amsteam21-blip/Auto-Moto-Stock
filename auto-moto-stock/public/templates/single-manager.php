...
do_action( 'amotos_single_manager_before_main_content' );
if (have_posts()):
	while (have_posts()): the_post(); ?>

		<?php amotos_get_template_part( 'content', 'single-manager' ); ?>

	<?php endwhile;
endif;
do_action( 'amotos_single_manager_after_main_content' );
/**
