...
$value = isset($_REQUEST[$name]) ? amotos_clean(wp_unslash($_REQUEST[$name] )) : '';
$label = isset($field['label']) ? amotos_clean(wp_unslash($field['label']))  : '';
...
$input_classes = array(
	'form-control',
	'search-field',
	'amotos-custom-search-field',
	'amotos-custom-search-field-select',
	"amotos-{$name}"
);
