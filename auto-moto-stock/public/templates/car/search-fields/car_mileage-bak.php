 ...
 * @var $request_min_mileage
 * @var $request_max_mileage
...
if ($mileage_is_slider=='true'):
    ...
    <div class="<?php echo esc_attr($css_class_field); ?> form-group">
        <?php if (!empty($request_min_mileage) && !empty($request_max_mileage)) {
        ...
        <div class="amotos-sliderbar-mileage amotos-sliderbar-filter"
            ...
            <div class="title-slider-filter">
                <span><?php esc_html_e('Mileage', 'auto-moto-stock') ?> [</span><span
                    ...
                    <input type="hidden" name="min-mileage" class="min-input-request"
                           value="<?php echo esc_attr($min_mileage_change) ?>">
                                        <input type="hidden" name="max-mileage" class="max-input-request"
...
<?php else: ?>
    <div class="<?php echo esc_attr($css_class_half_field); ?> form-group">
        <select name="min-mileage" title="<?php esc_attr_e('Min Mileage', 'auto-moto-stock') ?>"
                class="search-field form-control" data-default-value="">
            <option value="">
                <?php esc_html_e('Min Mileage', 'auto-moto-stock') ?>
            </option>
            <?php
    ...
    <div class="<?php echo esc_attr($css_class_half_field); ?> form-group">
        <select name="max-mileage" title="<?php esc_attr_e('Max Mileage', 'auto-moto-stock') ?>"
                class="search-field form-control" data-default-value="">
            <option value="">
                <?php esc_html_e('Max Mileage', 'auto-moto-stock') ?>
            </option>
            <?php
