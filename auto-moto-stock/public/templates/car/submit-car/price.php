...
<div class="car-fields-wrap">
    <div class="amotos-heading-style2 car-fields-title">
        <h2><?php esc_html_e( 'Price', 'auto-moto-stock' ); ?></h2>
    </div>
        ...
        ?>
            <div class="<?php echo esc_attr($price_short_class); ?>">
                <div class="form-group">
                    ...
                    echo sprintf(esc_html__('Example value: 1745%s25','auto-moto-stock'),
                    esc_html($dec_point) ) ?></small>
                </div>
            </div>
        ...
        if (!in_array("car_price_on_call", $hide_car_fields)) {?>
            <div class="col-sm-12">
                <div class="form-group form-check">
                    <input type="checkbox" class="form-check-input" id="car_price_on_call" name="car_price_on_call">
