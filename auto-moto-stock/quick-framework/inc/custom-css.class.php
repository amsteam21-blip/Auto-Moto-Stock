...
if (!class_exists('SQUICK_Inc_Custom_Css')) {
	class SQUICK_Inc_Custom_Css
	{
		/*
		 * loader instances
		 */
        ...
        public function initCustomCss() {
            echo '<style type="text/css" id="squick-custom-css"></style>';
        }

        public function renderCustomCss() {
            echo sprintf('<script>jQuery("style#squick-custom-css").append(%s);</script>',wp_json_encode($this->getCss()));
        }
	}
}