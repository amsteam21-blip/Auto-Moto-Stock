...
if (!class_exists('SQUICK_Field_Editor')) {
	class SQUICK_Field_Editor extends SQUICK_Field
	{
		function enqueue()
		{
			wp_enqueue_script(SQUICK()->assetsHandle('field_editor'), SQUICK()->helper()->getAssetUrl('fields/editor/assets/editor.min.js'), array(), SQUICK()->pluginVer(), true);
		}
		function renderContent()
		{
			...
			?>
			<div class="squick-field-editor-inner">
