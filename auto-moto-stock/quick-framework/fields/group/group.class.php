...
if (!class_exists('SQUICK_Field_Group')) {
	class SQUICK_Field_Group extends  SQUICK_Field {
		public function render() {
			...
			<div <?php $this->theFieldAttribute()?> class="<?php echo esc_attr(join(' ', $field_classes)); ?>">
					<h4 class="squick-field-group-title">
						<?php echo esc_html($this->_setting['title']); ?>
						<span class="squick-field-group-title-toggle"></span>
					</h4>
					<div class="squick-field-group-content" <?php SQUICK()->helper()->render_html_attr($attr_style); ?>>
					...
					</div><!-- /.squick-field-group-content -->
			</div><!-- /.squick-field-row -->
		<?php
		}
	}
}