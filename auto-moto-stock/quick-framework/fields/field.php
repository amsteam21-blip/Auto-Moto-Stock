...
if (!class_exists('SQUICK_Field')) {
	abstract class SQUICK_Field {
		public $_parentType = '';
		...
		public function getName() {
			...
			$prefix = SQUICK()->helper()->getFieldPrefix();
		...
		public function getLayout() {
			return isset($this->_setting['layout']) ? $this->_setting['layout'] : SQUICK()->helper()->getFieldLayout();
		}
		...
		public function renderStart() {
			...
			?>
			<?php if ($this->isInRow()): ?>
				<?php $field_classes[] = 'squick-col squick-col-' . $this->getCol(); ?>
				<div <?php $this->theFieldAttribute()?> class="<?php echo esc_attr(join(' ', $field_classes)); ?>">
					<div class="squick-col-inner squick-col-layout-<?php echo esc_attr($this->getLayout()); ?>">
			<?php else:; ?>
				<?php $field_classes[] = 'squick-layout-' . $this->getLayout(); ?>
				<div <?php $this->theFieldAttribute()?> class="<?php echo esc_attr(join(' ', $field_classes)); ?>">
					<div class="squick-row">
						<div class="squick-col squick-col-<?php echo esc_attr($this->getCol()); ?>">
							<div class="squick-col-inner squick-col-layout-<?php echo esc_attr($this->getLayout()); ?>">
			<?php endif;?>
			<?php
		}
		...
		public function renderLabel() {
			...
			<div class="squick-label">
				<div class="squick-title"><?php echo wp_kses_post($this->getFieldTitle()); ?></div>
				<?php if (!empty($subtitle)): ?>
					<div class="squick-subtitle">
		...
		public function renderDescription() {
			...
			<?php if (!empty($this->_setting['desc'])): ?>
				<p class="squick-desc"><?php echo wp_kses_post($this->_setting['desc']); ?></p>
			<?php endif;?>
			<?php
		}
		...
		public function renderCloneRemoveButton() {
			$btn_class = 'squick-clone-button-remove';
			if ($this->getType() === 'repeater') {
				$btn_class .= ' squick-is-repeater';
			}
			?>
		...
		public function renderCloneSortButton() {
			$btn_class = 'squick-sortable-button';
			if ($this->getType() === 'repeater') {
				$btn_class .= ' squick-is-repeater';
			}
			?>
		...
		public function renderContentWrapper() {
			...
			<div class="squick-field-content">
				<?php if ($this->isClone()): ?>
					...
					?>
					<div class="squick-field-clone-wrapper <?php echo esc_attr($this->isSort() ? 'squick-field-clone-sortable' : ''); ?>">
						<?php for ($index = 0; $index < $count_clone; $index++): ?>
							<div class="squick-field-clone-item" data-clone-index="<?php echo esc_attr($index); ?>">
