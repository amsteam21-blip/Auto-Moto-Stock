...
if (!class_exists('SQUICK_Field_Text')) {
	class SQUICK_Field_Text extends  SQUICK_Field {
		function enqueue() {
			wp_enqueue_script(SQUICK()->assetsHandle('field_text'), SQUICK()->helper()->getAssetUrl('fields/text/assets/text.min.js'), array(), SQUICK()->pluginVer(), true);
			wp_enqueue_style(SQUICK()->assetsHandle('field_text'), SQUICK()->helper()->getAssetUrl('fields/text/assets/text.min.css'), array(), SQUICK()->pluginVer());
		}
		...
		public function getFieldClass()  {
			...
			if ($input_type === 'unique_id') {
				$field_class[] = 'squick-hidden-field';
			}
