 ...
 * Define class field
 */
var SQUICK_Button_setClass = function($container) {
...
(function($) {
	 ...
	 */
	SQUICK_Button_setClass.prototype = {
		init: function() {
			var self = this;
		...
		getValue: function() {
			var isMultiple = this.$container.find('.squick-field-button_set-inner').data('multiple'),
				val = isMultiple ? [] : '';
			if (isMultiple) {
