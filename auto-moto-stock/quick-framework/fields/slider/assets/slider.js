 ...
 * Define class field
 */
var SQUICK_SliderClass = function($container) {
...
(function($) {
	 ...
	 */
	SQUICK_SliderClass.prototype = {
		init: function() {
			var self = this,
				$slider = self.$container.find('.squick-slider-place'),
				slider = $slider[0],
		...
		getValue: function() {
			if (this.$container.find('.squick-field-slider-range').length) {
				var val = {};
