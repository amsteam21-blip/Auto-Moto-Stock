 ...
 * Define class field
 */
var SQUICK_MapClass = function($container) {
...
(function($) {
	 ...
	 */
	SQUICK_MapClass.prototype = {
		init: function() {
			this.$location = this.$container.find('.squick-map-location-field');
			this.$address = this.$container.find('.squick-map-address input');
			this.$findAddress = this.$container.find('.squick-map-address button');
			this.$canvas = this.$container.find('.squick-map-canvas');
		...
		changeField: function() {
			this.$container.find('.squick-map-location-field').trigger('squick_field_control_changed');
		},
		getValue: function() {
			var val = {};
