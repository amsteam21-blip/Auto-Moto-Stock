 ...
 * Define class field
 */
var SQUICK_Select_ajaxClass = function($container) {
...
(function($) {
     ...
     */
    SQUICK_Select_ajaxClass.prototype = {
        init: function() {
            var self = this,
                $selectField = self.$container.find('.squick-select-ajax'),
